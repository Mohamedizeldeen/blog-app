...
<head>
    ...
    <title>Podcasts - Dashboard</title>
    ...
    <div class="container mx-auto py-8 px-4">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold text-gray-800">Podcasts</h1>
                <div class="space-x-4">
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                @forelse($podcasts as $podcast)
                    <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                        ...
                        <div class="p-4">
                            <h3 class="text-lg font-semibold text-gray-800 mb-2">{{ $podcast->title }}</h3>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <form action="{{ route('podcasts.destroy', $podcast->id) }}" method="POST" 
                                      onsubmit="return confirm('Are you sure you want to delete this podcast?')" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
